<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:41:"template/wap\default\Pay\pcWeChatPay.html";i:1509609226;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
	...
	<script>
		...
		function wchatOverdue() {
			...
			if (time != 0) {
				...
				$(".js-weixinInfo").html("<span class='font-red'><?php echo lang('the_two_dimensional_code_has_expired'); ?></span>，<?php echo lang('after_expiration_refresh_page_get_two_dimensional_code_again'); ?>。");
		...
		function payStatu(){
			$.ajax({
				type : "post",
				url : "<?php echo __URL('APP_MAIN/pay/wchatQrcodePay'); ?>",
				data : {
