<?php if (!defined('THINK_PATH')) exit(); /*a:10:{s:48:"template/adminblue\Goods\selectCategoryNext.html";i:1511575750;s:28:"template/adminblue\base.html";i:1512444889;s:45:"template/adminblue\controlCommonVariable.html";i:1515231611;s:61:"template/adminblue\Goods\controlEditGoodsCommonResources.html";i:1511510753;s:32:"template/adminblue\urlModel.html";i:1510819828;s:42:"template/adminblue\Goods\fileAlbumImg.html";i:1509621313;s:56:"template/adminblue\Goods\controlEditGoodsCommonHTML.html";i:1510372908;s:58:"template/adminblue\Goods\controlEditGoodsCommonScript.html";i:1511314053;s:34:"template/adminblue\pageCommon.html";i:1515372762;s:34:"template/adminblue\openDialog.html";i:1509523953;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
.js-virtual-goods-type-block{display: none;}
</style>
<script>
...
<div class="ncsc-form-goods">
		...
		<dd>
			<div class="controls brand-controls">
				<select id="virtual_goods_type_id">
					...
					<?php if(is_array($virtual_goods_type_list) || $virtual_goods_type_list instanceof \think\Collection || $virtual_goods_type_list instanceof \think\Paginator): if( count($virtual_goods_type_list)==0 ) : echo "" ;else: foreach($virtual_goods_type_list as $key=>$virtual_goods_type): ?>
					<option value="<?php echo $virtual_goods_type['virtual_goods_type_id']; ?>"><?php echo $virtual_goods_type['virtual_goods_type_name']; ?></option>
					<?php endforeach; endif; else: echo "" ;endif; ?>
	...
	<dl>
		...
		<dd>
			<input class="productname" type="text" id="txtProductTitle" placeholder="请输入商品名称，不能超过60个字" oninput='if(value.length>60){value=value.slice(0,60);$(this).next().text("商品名称不能超过60个字符").show();}else{$(this).next().hide();}'/>
	...
	<dl>
		<dt>商品促销语：</dt>
		<dd>
			<input class="productname" type="text" id="txtIntroduction" placeholder="请输入促销语，不能超过60个字符" oninput='if(value.length>60){value=value.slice(0,60);$(this).next().text("促销语不能超过60个字符").show();}else{$(this).next().hide();}'/>
	...
	<dl>
		<dt>生产日期：</dt>
		<dd>
			<input type="text" id="production_date" onclick="WdatePicker()">
		</dd>
	</dl>
	<dl>
		<dt>保质期：</dt>
		<dd>
			<input type="text" id="shelf_life" maxlength="45">
		</dd>
	</dl>
	<dl>
