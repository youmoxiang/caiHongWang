<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:43:"template/adminblue\Member\supplierList.html";i:1508414315;s:28:"template/adminblue\base.html";i:1512444889;s:45:"template/adminblue\controlCommonVariable.html";i:1515231611;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1515372762;s:34:"template/adminblue\openDialog.html";i:1509523953;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		...
		success : function(data) {
			...
			if (data["data"].length > 0) {
				for (var i = 0; i < data["data"].length; i++) {
					...
					html += '<td><input name="sub" type="checkbox" value="'+ data["data"][i]["supplier_id"]+'" ></td>';
					html += '<td>'+ data["data"][i]["supplier_name"]+'</td>';
					html += '<td>'+ data["data"][i]["linkman_name"]+'</td>';
					html += '<td>'+ data["data"][i]["linkman_tel"]+'</td>';
					html += '<td>'+ data["data"][i]["linkman_address"]+'</td>';
					html += '<td>' + data['data'][i]['desc'] + '</td>';
					html += '<td> <a href="'+__URL('ADMIN_MAIN/Member/updatesupplier?supplier_id='+ data['data'][i]['supplier_id'])+'">修改</a>';
		...
		buttons: {
			"确定": function() {
				$.ajax({
					...
					success : function(data) {
						if (data['code'] > 0) {
							showMessage('success', data["message"], "<?php echo __URL('ADMIN_MAIN/member/supplierlist'); ?>");
						} else if(data['code'] == -1){
