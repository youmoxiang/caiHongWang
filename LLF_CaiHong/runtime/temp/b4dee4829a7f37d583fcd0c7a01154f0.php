<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:52:"template/adminblue\Config\memberWithdrawSetting.html";i:1505986835;s:28:"template/adminblue\base.html";i:1512444889;s:45:"template/adminblue\controlCommonVariable.html";i:1515231611;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1515372762;s:34:"template/adminblue\openDialog.html";i:1509523953;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<dl>
		<dt>最低提现金额:</dt>
		<dd>
			<input id="cash_min" type="number" min="0.00" value="<?php echo $list['value']['withdraw_cash_min']; ?>" class="input-common"/>
	...
	<dl>
		<dt>提现倍数:</dt>
		<dd>
			<input id="multiple" type="number" min="0.00" value="<?php echo $list['value']['withdraw_multiple']; ?>" class="input-common" />
	...
	<dl>
		<dt>提现提示信息:</dt>
		<dd>
			<textarea rows="2" id="message" class="textarea input-common" maxlength="50"><?php echo $list['value']['withdraw_message']; ?></textarea>
...
function setMemberwithdrawAjax() {
	...
	if(validation){
		$.ajax({
			type : "post",
			url : "<?php echo __URL('ADMIN_MAIN/config/memberwithdrawsetting'); ?>",
			data : {
				'cash_min' : cash_min,
				'multiple' : multiple,
				'poundage' : poundage,
