<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:43:"template/adminblue\Extend\addonsConfig.html";i:1501559752;s:28:"template/adminblue\base.html";i:1512444889;s:45:"template/adminblue\controlCommonVariable.html";i:1515231611;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1515372762;s:34:"template/adminblue\openDialog.html";i:1509523953;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<?php
	if(config_hook != ''){
		echo hook("$config_hook");
	}else{
	?>
		<form action="<?php echo __URL('ADMIN_MAIN/extend/saveAddonsConfig'); ?>" class="form-horizontal" method="post">
			<?php if(is_array($data['config']) || $data['config'] instanceof \think\Collection || $data['config'] instanceof \think\Paginator): if( count($data['config'])==0 ) : echo "" ;else: foreach($data['config'] as $key=>$form): switch($form['type']): case "text": ?>
						<dl>
							<dt><?php echo $form['title']; ?>:</dt>
							<dd>
								<p><input type="text" name="config[<?php echo $key; ?>]" value="<?php echo $form['value']; ?>" class="input-common"></p>
								<p class="hint"><?php echo $form['tip']; ?></p>
							</dd>
						</dl>
					<?php break; case "password": ?>
						<dl>
							<dt><?php echo $form['title']; ?>:</dt>
							<dd>
								<p><input type="password" name="config[<?php echo $key; ?>]" value="<?php echo $form['value']; ?>" class="input-common"></p>
								<p class="hint"><?php echo $form['tip']; ?></p>
							</dd>
						</dl>
			...
			<dl>
				<dt></dt>
				<dd>
					<button type="submit" class="btn-common btn-big">确定</button>
