<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:50:"template/adminblue\Goods\editVirtualGoodsType.html";i:1511596986;s:28:"template/adminblue\base.html";i:1512444889;s:45:"template/adminblue\controlCommonVariable.html";i:1515231611;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1515372762;s:34:"template/adminblue\openDialog.html";i:1509523953;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<dl>
		...
		<dd>
			<?php if($virtual_goods_type): ?>
			<input id="virtual_goods_type_name" type="text" placeholder="请输入虚拟商品类型名称" class="input-common" value="<?php echo $virtual_goods_type['virtual_goods_type_name']; ?>"/>
			<?php else: ?>
	...
	<dl>
		...
		<dd>
			<?php if($virtual_goods_type): ?>
			<input id="validity_period" type="text" placeholder="请输入有效期/天(0表示不限制)" class="input-common" value="<?php echo $virtual_goods_type['validity_period']; ?>"/>
			<?php else: ?>
	...
	<dl>
		...
		<dd>
			<?php if($virtual_goods_type): ?>
			<input id="money" type="text" placeholder="请输入金额" class="input-common" value="<?php echo $virtual_goods_type['money']; ?>"/>
			<?php else: ?>
	...
	<dl>
		...
		<dd>
			<?php if($virtual_goods_type): ?>
			<input id="confine_use_number" type="text" placeholder="请输入限制使用次数(0表示不限制)" class="input-common" value="<?php echo $virtual_goods_type['confine_use_number']; ?>"/>
			<?php else: ?>
	...
	<!-- <dl>
		...
		<dd>
			<?php if($virtual_goods_type): ?>
			<input id="interfaces" type="text" placeholder="请输入接口地址" class="input-common" value="<?php echo $virtual_goods_type['config_info']; ?>"/>
			<?php else: ?>
	...
	<dl>
		<dt>是否启用</dt>
		<dd>
			<?php if($virtual_goods_type): if($virtual_goods_type['is_enabled'] == 1): ?>
...
<input type="hidden" id="hidden_virtual_goods_type_id" value="<?php echo $virtual_goods_type_id; ?>" />
<script>
function validation() {
...
function save() {
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/goods/editVirtualGoodsType'); ?>",
		data : {
		...
		success : function(res) {
			if (res.code > 0) {
				...
				setTimeout(function(){
					location.href = "<?php echo __URL('ADMIN_MAIN/goods/virtualGoodsTypeList'); ?>";
				},1200);
			} else {
				flag = false;
