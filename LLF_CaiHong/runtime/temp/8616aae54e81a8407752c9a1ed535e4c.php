<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:43:"template/adminblue\Config\payAliConfig.html";i:1501559758;s:28:"template/adminblue\base.html";i:1512444890;s:45:"template/adminblue\controlCommonVariable.html";i:1515231612;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1515372762;s:34:"template/adminblue\openDialog.html";i:1509523954;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<dl>
		<dt>账号：</dt>
		<dd><input id="ali_seller" type="text" value="<?php echo $config['value']['ali_seller']; ?>" class="input-common" /></dd>
	</dl>
	<dl>
		<dt>合作者身份ID：</dt>
		<dd><input id="ali_partnerid" type="text" value="<?php echo $config['value']['ali_partnerid']; ?>" class="input-common" /></dd>
	</dl>
		<dl>
		<dt>安全校验码：</dt>
		<dd><input id="ali_key" type="text" value="<?php echo $config['value']['ali_key']; ?>" class="input-common" /></dd>
	</dl>
	<dl>
		<dt>是否启用：</dt>
		<dd>
...
function setConfigAjax(){
	...
	$.ajax({
		type:"post",
		url:"<?php echo __URL('ADMIN_MAIN/config/payaliconfig'); ?>",
		data:{
