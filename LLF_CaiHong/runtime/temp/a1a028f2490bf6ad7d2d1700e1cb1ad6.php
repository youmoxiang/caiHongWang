<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:48:"template/adminblue\Config\addShopNavigation.html";i:1501559758;s:28:"template/adminblue\base.html";i:1512444889;s:45:"template/adminblue\controlCommonVariable.html";i:1515231611;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1515372762;s:34:"template/adminblue\openDialog.html";i:1509523953;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	...
	<dl>
		<dt>排序号</dt>
		<dd><input id="sort" type="number" value="0" class="input-common" min="0"/></dd>
	</dl>
	<dl>
		<dt><span style="color:red;margin-right:10px;">*</span>链接地址</dt>
		<dt style="width: 100px;text-align: left;">
			<label for="url_type1" style="margin-top: 5px;margin-left: 10px;"><input type="radio" value="0" name="url_type" id="url_type1" checked="checked"/>商城模块</label>
		</dt>
		<dt style="text-align: left;">
			<label for="url_type2" style="margin-top: 5px;"><input type="radio" value="1" name="url_type" id="url_type2" />自定义链接</label>
		</dt>
	</dl>
	<dl>
		<dt></dt>
		<dd>
			<select class="select-common" id="shopNavModel">
				...
				<?php if(!(empty($shopNavTemplate) || (($shopNavTemplate instanceof \think\Collection || $shopNavTemplate instanceof \think\Paginator ) && $shopNavTemplate->isEmpty()))): if(is_array($shopNavTemplate) || $shopNavTemplate instanceof \think\Collection || $shopNavTemplate instanceof \think\Paginator): if( count($shopNavTemplate)==0 ) : echo "" ;else: foreach($shopNavTemplate as $key=>$vo): ?>
				<option value="<?php echo $vo['template_url']; ?>"><?php echo $vo['template_name']; ?></option>
				<?php endforeach; endif; else: echo "" ;endif; endif; ?>
			</select>
			<span style="display: none;" id="nav_url">
				<input type="text" class="input-common" name="nav_url" style="width:210px;margin-bottom: 5px;"/>
	...
	<dl>
		...
		<dd>
			<div id="position_type">
				...
				<label for="navigationtype3" class="line-label"><input type="radio" value="3" name="navigationtype" id="navigationtype3" checked="checked" />底部</label>
			</div>
		</dd>
	</dl>
	<dl>
		...
		<dd>
			<div id="blank_type">
				...
				<label for="is_blank2" class="line-label"><input type="radio" value="0" name="is_blank" id="is_blank2" checked="checked" />否</label>
			</div>
		</dd>
	</dl>
	<dl>
		<dt></dt>
		<dd><button class="btn-common btn-big" onclick="save()">添加</button></dd>
	</dl>
</div>
...
function save(){
	...
	$.ajax({
		type:"post",
		url:"<?php echo __URL('ADMIN_MAIN/config/addshopnavigation'); ?>",
		data:{
		'nav_title':nav_title,
		'sort':sort,
		'nav_url':nav_url,
