<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:42:"template/adminblue\Config\loginConfig.html";i:1511001546;s:28:"template/adminblue\base.html";i:1512444889;s:45:"template/adminblue\controlCommonVariable.html";i:1515231611;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1515372762;s:34:"template/adminblue\openDialog.html";i:1509523953;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<dl>
		<dt>APP_ID:</dt>
		<dd><input id="APP_KEY" type="text" value="<?php echo $qq_config['value']['APP_KEY']; ?>" class="input-common" /></dd>
	</dl>
	<dl>
		<dt>APP_KEY:</dt>
		<dd><input id="APP_SECRET" type="text" value="<?php echo $qq_config['value']['APP_SECRET']; ?>" class="input-common" /></dd>
	</dl>
	<dl>
		<dt>是否启用:</dt>
		<dd>
...
function setConfigAjax(){
	...
	$.ajax({
		...
		success:function (data) {
			if (data["code"] > 0) {
				showMessage('success', data["message"],"<?php echo __URL('ADMIN_MAIN/config/partylogin'); ?>");
			}else{
...
<div class="set-style">
	<dl>
		<dt>APP_KEY:</dt>
		<dd><input id="APP_KEY" type="text" value="<?php echo $wchat_config['value']['APP_KEY']; ?>" class="input-common" /></dd>
	</dl>
	<dl>
		<dt>APP_SECRET:</dt>
		<dd><input id="APP_SECRET" type="text" value="<?php echo $wchat_config['value']['APP_SECRET']; ?>" class="input-common" /></dd>
	</dl>
	<dl>
		<dt>是否启用:</dt>
		<dd>
	...
	<dl>
		...
		<p style="color:#999999;">(申请<a href="https://open.weixin.qq.com/">微信开放平台</a> 网站应用,授权回调域:<?php echo $_SERVER['HTTP_HOST']; ?>)</p>
		</dd>
	</dl>
	<dl>
		<dt>回调域名:</dt>
