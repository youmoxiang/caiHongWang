<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:44:"template/adminblue\Upgrade\onlineUpdate.html";i:1517364004;s:28:"template/adminblue\base.html";i:1512444890;s:45:"template/adminblue\controlCommonVariable.html";i:1515231612;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1515372762;s:34:"template/adminblue\openDialog.html";i:1509523954;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		...
		<table>
			<tbody>
				...
				<tr>
					<td>授权账号：
					<!-- <?php if($result != ''): ?>
						<?php echo $devolution_user_name; ?>  -->&nbsp;&nbsp;<a href="__TEMP__/<?php echo $style; ?>/../shop/blue/biaobai.html" target="_blank" style="color:#666;"">重新绑定</a>
					
					
					<!-- <?php else: ?> onclick="bind()
					&nbsp;&nbsp;<a href="javascript:;" target="_blank" style="color:#666;" onclick="bind()">立即绑定</a>
					<?php endif; ?> -->
					</td>
				</tr>
				<tr><td>站点URL：www.caihongwang.com<!-- <?php echo $result['data']['devolution_url']; ?> --></td></tr>
				<tr><td>授权时间：9999-99-99	99:99:99
				<!-- <?php if(!(empty($result['data']['devolution_obj']['devolution_date']) || (($result['data']['devolution_obj']['devolution_date'] instanceof \think\Collection || $result['data']['devolution_obj']['devolution_date'] instanceof \think\Paginator ) && $result['data']['devolution_obj']['devolution_date']->isEmpty()))): ?>
						        	<?php echo date("Y-m-d",strtotime($result['data']['devolution_obj']['devolution_date'])); endif; ?> --></td></tr>
				<tr><td >当前版本：<?php echo $niu_version; ?></td></tr>
				<tr><td >服务器版本：5.20<!-- <?php echo $latestVersion['data']['latest_version']; ?> --></td></tr>
				<tr><td >授权版本：5.20<!-- <?php echo $result['data']['devolution_version_name']; ?> --></td></tr>
				<?php if($result['code'] == 0): ?>
					<tr><td >授权状态：<span style="color:red">已授权</span>&nbsp;&nbsp;&nbsp;&nbsp;</td></tr>
				<?php else: ?>
					<tr><td >授权状态：<span style="color:red">已授权</span>&nbsp;&nbsp;&nbsp;&nbsp;<a href="__TEMP__/<?php echo $style; ?>/../shop/blue/biaobai.html" target="_blank" style="color:#666;text-decoration: underline;">去查看</a></td></tr>
				<?php endif; ?>
			</tbody>
		</table>
	</div>
			...
			<div class="modal-body">
				<div class="modal-infp-style" style="height:165px;width:320px;margin:auto;">
					<table class="modal-tab" style="width: 100%;">
						<tr>
							<td colspan="2" style="text-align:left">输入QQ号完成绑定
							<a style="float:right;color:#00C0FF;" href="__TEMP__/<?php echo $style; ?>/../shop/blue/biaobai.html" target="_blank" >授权</a>
							</td>
						</tr>
						<tr>
							<td>用户名：</td>
...
function bind_mess(){
	...
	$.ajax({
		type:'post',
		url : "<?php echo __URL('ADMIN_MAIN/Upgrade/onlineUpdate'); ?>",
		data:{
			'user_name':user_name,
			'password':user_pass
		},
