<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:36:"template/adminblue\Auth\addUser.html";i:1501559754;s:28:"template/adminblue\base.html";i:1512444889;s:45:"template/adminblue\controlCommonVariable.html";i:1515231611;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1515372762;s:34:"template/adminblue\openDialog.html";i:1509523953;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		...
		<dd>
			<p>
				<select class="input-common" id="group_id">
					...
					<?php if(is_array($auth_group) || $auth_group instanceof \think\Collection || $auth_group instanceof \think\Paginator): if( count($auth_group)==0 ) : echo "" ;else: foreach($auth_group as $key=>$v1): ?>
					<option value="<?php echo $v1['group_id']; ?>">&nbsp;&nbsp;<?php echo $v1['group_name']; ?></option>
					<?php endforeach; endif; else: echo "" ;endif; ?>
				</select>
			</p>
...
function addUserAjax() {
	...
	if(verify() && !flag){
		...
		$.ajax({
			type : "post",
			url : "<?php echo __URL('ADMIN_MAIN/auth/adduser'); ?>",
			data : {
			...
			success : function(data) {
				if (data['code'] > 0) {
					$("#dialog").dialog({
						...
						time : 2,
						timeHref : "<?php echo __URL('ADMIN_MAIN/auth/userlist'); ?>",
					});
				} else {
					$("#dialog").dialog({
						buttons : {
