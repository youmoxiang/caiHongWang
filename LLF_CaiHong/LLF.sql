...
CREATE TABLE sys_version_patch (
  ...
  patch_type INT(11) NOT NULL DEFAULT 1 COMMENT '补丁类型  1. 单用户商城 2. 单用户分销商城 3 多用户商城',
...
(17, 87, 6, '用户注册协议', '', 0, '<p><span style="color: rgb(102, 102, 102); font-family: &quot;Microsoft Yahei&quot;, &quot;Lucida Grande&quot;, Verdana, Lucida, Helvetica, Arial, sans-serif; font-size: 12px; background-color: rgb(255, 255, 255);">LLF-彩虹网商城用户注册协议本协议是您与LLF-彩虹网商城网站（简称&quot;本站&quot;）所有者（以下简称为&quot;LLF-彩虹网商城&quot;）之间就LLF-彩虹网商城网站服务等相关事宜所订立的契约，请您仔细阅读本注册协议，您点击&quot;同意并继续&quot;按钮后，本协议即构成对双方有约束力的法律文件。第1条 本站服务条款的确认和接纳1.1本站的各项电子服务的所有权和运作权归LLF-彩虹网商城所有。用户同意所有注册协议条款并完成注册程序，才能成为本站的正式用户。用户确认：本协议条款是处理双方权利义务的契约，始终有效，法律另有强制性规定或双方另有特别约定的，依其规定。1.2用户点击同意本协议的，即视为用户确认自己具有享受本站服务、下单购物等相应的权利能力和行为能力，能够独立承担法律责任。1.3如果您在18周岁以下，您只能在父母或监护人的监护参与下才能使用本站。第2条 本站服务2.9LLF-彩虹网商城通过互联网依法为用户提供互联网信息等服务，用户在完全同意本协议及本站规定的情况下，方有权使用本站的相关服务。2.2用户必须自行准备如下设备和承担如下开支：（1）上网设备，包括并不限于电脑或者其他上网终端、调制解调器及其他必备的上网装置；（2）上网开支，包括并不限于网络接入费、上网设备租用费、手机流量费等。第3条 用户信息3.1用户应自行诚信向本站提供注册资料，用户同意其提供的注册资料真实、准确、完整、合法有效，用户注册资料如有变动的，应及时更新其注册资料。如果用户提供的注册资料不合法、不真实、不准确、不详尽的，用户需承担因此引起的相应责任及后果，并且LLF-彩虹网商城保留终止用户使用LLF-彩虹网商城各项服务的权利。3.2用户在本站进行浏览、下单购物等活动时，涉及用户真实姓名/名称、通信地址、联系电话、电子邮箱等隐私信息的，本站将予以严格保密，除非得到用户的授权或法律另有规定，本站不会向外界披露用户隐私信息。第4条 用户依法言行义务本协议依据国家相关法律法规规章制定，用户同意严格遵守以下义务：（1）不得传输或发表：煽动抗拒、破坏宪法和法律、行政法规实施的言论，煽动颠覆国家政权，推翻社会主义制度的言论，煽动分裂国家、破坏国家统一的的言论，煽动民族仇恨、民族歧视、破坏民族团结的言论；（2）从中国大陆向境外传输资料信息时必须符合中国有关法规；第5条 其他5.1LLF-彩虹网商城网站所有者是指在政府部门依法许可或备案的LLF-彩虹网商城网站经营主体。5.2您点击本协议下方的&quot;同意并继续&quot;按钮即视为您完全接受本协议，在点击之前请您再次确认已知悉并完全理解本协议的全部内容。</span></p>', '', 1499325553, 1499325616);
...
(17, 0, 'QQLOGIN', '{"APP_KEY":"","APP_SECRET":"","AUTHORIZE":"http:\\/\\/www.qq.com","CALLBACK":"http:\\/\\/www.qq.com\\/wap\\/login\\/callback"}', 'qq', 0, 1488350925, 1497105447),
(18, 0, 'WCHAT', '{"APP_KEY":"","APP_SECRET":"","AUTHORIZE":"http:\\/\\/www.qq.com","CALLBACK":"http:\\/\\/www.qq.com\\/wap\\/Login\\/callback"}', '微信', 0, 1488350947, 1497105440),
...
(10000, '网云', 'admin', 'upgrade', 'onlineupdate', 0, 1, 'upgrade/onlineupdate', 1, 0, 100, '', '', '', 1, 1499398784, 1499398784),
...
(1, 'LLF-彩虹网商城', 'public/static/images/default_img_url/logo.png', 'LLF-彩虹网商城', '', '5201314', 2, '广东珠海市', 'public/static/images/default_img_url/qrcode.png', 'http://www.qq.com/', '315405479@qq.com', '400-000-0000', '520-1314', 'love520', 1, '', '对不起，LLF-彩虹网商城维护中，大家敬请期待...', 1, 4, 5200000, 5200000, 0, '', '', '', '');
