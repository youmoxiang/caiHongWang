<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:40:"template/adminblue\Config\payConfig.html";i:1502451388;s:28:"template/adminblue\base.html";i:1512444890;s:45:"template/adminblue\controlCommonVariable.html";i:1515231612;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1515372762;s:34:"template/adminblue\openDialog.html";i:1509523954;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<dl>
		<dt>应用ID[AppID]:</dt>
		<dd><input id="APP_KEY" type="text" value="<?php echo $config['value']['appid']; ?>" class="input-common" /></dd>
	</dl>
	<dl>
		<dt>应用密钥[AppSecrect]:</dt>
		<dd><input id="APP_SECRET" type="text" value="<?php echo $config['value']['appkey']; ?>" class="input-common" /></dd>
	</dl>
		<dl>
		<dt>支付专用签名串[paySignKey]:</dt>
		<dd><input id="paySignKey" type="text" value="<?php echo $config['value']['mch_key']; ?>" class="input-common" /></dd>
	</dl>
	<dl>
		<dt>微信支付商户号[MCHID]:</dt>
		<dd><input id="MCHID" type="text" value="<?php echo $config['value']['mch_id']; ?>" class="input-common" /></dd>
	</dl>
	<dl>
		<dt>支付授权目录:</dt>
...
function setConfigAjax(){
	...
	$.ajax({
		type:"post",
		url:"<?php echo __URL('ADMIN_MAIN/config/payconfig'); ?>",
		data:{
			'appkey':appkey,
			'appsecret':appsecret,
