<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:43:"template/adminblue\Config\notifyConfig.html";i:1512013748;s:28:"template/adminblue\base.html";i:1512444890;s:45:"template/adminblue\controlCommonVariable.html";i:1515231612;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1515372762;s:34:"template/adminblue\openDialog.html";i:1509523954;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<table class="table-class">
	...
	<tbody>
		<?php if(is_array($notify_list) || $notify_list instanceof \think\Collection || $notify_list instanceof \think\Paginator): $i = 0; $__LIST__ = $notify_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$notify_obj): $mod = ($i % 2 );++$i;?>
			<tr style="border:1px solid #e5e5e5;border-top:0;background:none;">
				<td style="background:none;text-align:center;"><?php echo $notify_obj['notify_name']; ?></td>
