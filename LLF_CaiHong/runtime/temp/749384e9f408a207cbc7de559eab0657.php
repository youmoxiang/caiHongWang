<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:50:"template/adminblue\Account\shopGoodsSalesRank.html";i:1501559754;s:28:"template/adminblue\base.html";i:1512444889;s:45:"template/adminblue\controlCommonVariable.html";i:1515231611;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1515372762;s:34:"template/adminblue\openDialog.html";i:1509523953;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="rank-box">
	...
	<ul class="rank-ul">
		<?php foreach($goods_list as $k=>$goods_info): ?>
		<li onclick="location.href='+__URL('ADMIN_MAIN/account/shopgoodsaccountlist?goods_id=<?php echo $goods_info['goods_id']; ?>)+';" title="<?php echo $goods_info['goods_name']; ?>">
			<table>
				<tr>
					<td style="border-right: 1px solid #e5e5e5;">
						<?php if($k == 0): ?>
						<span class="first"><?php echo $k + 1; ?></span>
						<?php elseif($k == 1): ?>
						<span class="second"><?php echo $k + 1; ?></span>
						<?php elseif($k == 2): ?>
						<span class="third"><?php echo $k + 1; ?></span>
						<?php else: ?>
					...
					<td>
						<?php if($k == 0): ?>
						<span class="first"><?php echo $goods_info['real_sales']; ?></span>
						<?php elseif($k == 1): ?>
						<span class="second"><?php echo $goods_info['real_sales']; ?></span>
						<?php elseif($k == 2): ?>
						<span class="third"><?php echo $goods_info['real_sales']; ?></span>
						<?php else: ?>
						<span><?php echo $goods_info['real_sales']; ?></span>
						<?php endif; ?>
					</td>
				</tr>
			</table>
