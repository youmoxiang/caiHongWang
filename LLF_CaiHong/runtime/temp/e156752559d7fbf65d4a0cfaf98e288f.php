<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:56:"template/adminblue\Config\originalRoadRefundSetting.html";i:1510285150;s:28:"template/adminblue\base.html";i:1512444890;s:45:"template/adminblue\controlCommonVariable.html";i:1515231612;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1515372762;s:34:"template/adminblue\openDialog.html";i:1509523954;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	...
	<dl>
		<dt>是否启用：</dt>
		<dd>
			<p><input id="is_use" type="checkbox" class="checkbox" <?php if(!$alipay_is_use): ?>disabled="disabled"<?php endif; if($original_road_refund_setting_info['is_use']): ?>checked="checked"<?php endif; ?>
			/></p>
	...
	<dl>
		<dt>是否启用：</dt>
		<dd>
			<p><input id="is_use" type="checkbox" class="checkbox" <?php if(!$wechat_is_use): ?>disabled="disabled"<?php endif; if($original_road_refund_setting_info['is_use']): ?>checked="checked"<?php endif; ?>/></p>
...
function save(){
	...
	if(validation()){
		...
		$.ajax({
			type : "post",
			url : "<?php echo __URL('ADMIN_MAIN/config/setOriginalRoadRefundSetting'); ?>",
			data : { type : "<?php echo $type; ?>", value : JSON.stringify(originalRoadRefund) },
