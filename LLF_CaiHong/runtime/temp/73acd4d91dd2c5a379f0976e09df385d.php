<?php if (!defined('THINK_PATH')) exit(); /*a:15:{s:40:"template/shop\blue\Member\orderList.html";i:1505987196;s:28:"template/shop\blue\base.html";i:1510626416;s:32:"template/shop\blue\urlModel.html";i:1510819886;s:34:"template/shop\blue\controlTop.html";i:1515575916;s:41:"template/shop\blue\controlHeadSerach.html";i:1515575836;s:44:"template/shop\blue\controlHeadSearchAdv.html";i:1515575820;s:43:"template/shop\blue\controlHeadGoodType.html";i:1515575810;s:40:"template/shop\blue\controlCommonNav.html";i:1502706002;s:46:"template/shop\blue\Member\controlLeftMenu.html";i:1511781218;s:41:"template/shop\blue\controlCommonPage.html";i:1502679158;s:45:"template/shop\blue\controlBottomLinkHelp.html";i:1515575766;s:37:"template/shop\blue\controlBottom.html";i:1517364912;s:34:"template/shop\blue\openDialog.html";i:1509523954;s:36:"template/shop\blue\controlLogin.html";i:1508897750;s:37:"template/shop\blue\baidu_js_push.html";i:1499844478;}*/ ?>
<!DOCTYPE html>
<html>
<head>
					...
					<tr class="order-bd">
						...
						<td rowspan="<?php echo count($order['order_item_list']); ?>" align="center" class="other">
							...
							<?php endforeach; endif; else: echo "" ;endif; endif; if($order['order_status'] == 3 OR $order['order_status'] == 4): if($order['is_evaluate'] == 0): ?>
								<a href="<?php echo __URL('SHOP_MAIN/member/reviewcommodity','orderid='.$order_item['order_id']); ?>" class="on_money" style="background-color:#FF9149;border: 1px solid  #FF9149;"><?php echo lang('member_i_want_evaluate'); ?></a>
								<?php elseif($order['is_evaluate'] == 1): ?>
								<a href="<?php echo __URL('SHOP_MAIN/member/reviewagain','orderid='.$order_item['order_id']); ?>" class="on_money" style="background-color:#FF9149;border: 1px solid  #FF9149;"><?php echo lang('goods_additional_evaluation'); ?></a>
								<?php endif; endif; ?>
						</td> 
					<?php endif; ?>
					</tr>
...
<div id="pagination" class="page" >
	...
	<div class="page-num fr">
		...
		<div id="page_list" style="float: left;<?php echo $path_info; ?>">
			...
			<!-- 总页数小于总页码时就都显示 -->
			<?php if($page_count <= $page_num): $__FOR_START_2910__=1;$__FOR_END_2910__=$page_count+1;for($i=$__FOR_START_2910__;$i < $__FOR_END_2910__;$i+=1){ if($i == $page): ?>
			...
			<?php elseif($page <= ($page_num-1)/2): $__FOR_START_27801__=1;$__FOR_END_27801__=$page_num+1;for($i=$__FOR_START_27801__;$i < $__FOR_END_27801__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info.'?page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 如果总页数等于当前页 或者 总页数小于当前页加上页码总数平均值显示 -->
			<?php elseif($page_count == $page or $page_count <= $page+($page_num-1)/2): $__FOR_START_29152__=$page_count-$page_num+1;$__FOR_END_29152__=$page_count+1;for($i=$__FOR_START_29152__;$i < $__FOR_END_29152__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info.'?page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 否则就正常显示 -->
			<?php else: $__FOR_START_13283__=$page-($page_num-1)/2;$__FOR_END_13283__=$page+($page_num-1)/2+1;for($i=$__FOR_START_13283__;$i < $__FOR_END_13283__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info.'?page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } endif; ?>
