<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:44:"template/adminblue\Config\messageConfig.html";i:1515375466;s:28:"template/adminblue\base.html";i:1512444889;s:45:"template/adminblue\controlCommonVariable.html";i:1515231611;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1515372762;s:34:"template/adminblue\openDialog.html";i:1509523953;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<dl>
		<dt>是否开启：</dt>
		<dd>
			<input id="email_is_use" type="checkbox" class="checkbox" <?php if($email_message['is_use']=='1'): ?>checked="checked"<?php endif; ?>/>
		</dd>
	</dl>
	<dl>
		<dt>SMTP服务器：</dt>
		<dd>
			<input id="email_host" type="text" value="<?php echo $email_message['value']['email_host']; ?>" class="input-common" />
		</dd>
	</dl>
	<dl>
		<dt>SMTP端口：</dt>
		<dd>
			<input id="email_port" type="text" value="<?php echo $email_message['value']['email_port']; ?>" class="input-common" />
		</dd>
	</dl>
	<dl>
		<dt>发信人邮件地址：</dt>
		<dd>
			<input id="email_addr" type="text" value="<?php echo $email_message['value']['email_addr']; ?>" class="input-common" />
		</dd>
	</dl>
	<dl>
		<dt>SMTP身份验证用户名：</dt>
		<dd>
			<input id="email_id" type="text" value="<?php echo $email_message['value']['email_id']; ?>" class="input-common" />
		</dd>
	</dl>
	<dl>
		<dt>SMTP身份验证码：</dt>
		<dd>
			<input id="email_pass" type="text" value="<?php echo $email_message['value']['email_pass']; ?>" class="input-common" />
		</dd>
	</dl>
	<dl>
		<dt>是否使用安全链接：</dt>
		<dd>
			<input id="email_is_security" type="checkbox" class="checkbox" <?php if($email_message['value']['email_is_security'] == 'true'): ?>checked="checked"<?php endif; ?>/>
		</dd>
	</dl>
	<dl>
		<dt>测试接收邮件地址：</dt>
		<dd>
			...
			<button class="btn-common" onclick="testSend()">测试发送</button>
		</dd>
	</dl>
	<dl>
		<dt></dt>
...
function setConfigAjax(){
	...
	$.ajax({
		type:"post",
		url:"<?php echo __URL('ADMIN_MAIN/config/setemailmessage'); ?>",
		data:{
			'is_use':is_use,
...
function testSend(){
	...
	$.ajax({
		type:"post",
		url:"<?php echo __URL('ADMIN_MAIN/config/testsend'); ?>",
		data:{
			'email_host':email_host,
			'email_port':email_port,
			'email_addr':email_addr,
...
<div class="set-style">
	<dl>
		<dt>是否开启：</dt>
		<dd style="width:5%;">
			<input id="sms_is_use" type="checkbox" class="checkbox" <?php if($mobile_message['is_use']=='1'): ?>checked="checked"<?php endif; ?>/>
		</dd>
	...
	<dl>
		<dt>APP_KEY：</dt>
		<dd>
			<input id="app_key" type="text" value="<?php echo $mobile_message['value']['appKey']; ?>" class="input-common" />
		</dd>
	</dl>
	<dl>
		<dt>SECRET_KEY：</dt>
		<dd>
			<input id="secret_key" type="text" value="<?php echo $mobile_message['value']['secretKey']; ?>" class="input-common" />
		</dd>
	</dl>
	<dl>
		<dt>短信内容签名：</dt>
		<dd>
			<input id="free_sign_name" type="text" value="<?php echo $mobile_message['value']['freeSignName']; ?>" class="input-common" />
		</dd>
	</dl>
	<dl>
		<dt>阿里大于用户：</dt>
		<dd class="user_type">
			...
			<input type="radio" value="0" name="user_type" id="user_type_old" <?php if($mobile_message['value']['user_type'] == 0): ?>checked="checked"<?php endif; ?> />
			<label for="user_type_old">旧用户</label>
			
			<input type="radio" value="1" name="user_type" id="user_type_new" <?php if($mobile_message['value']['user_type'] == 1): ?>checked="checked"<?php endif; ?> />
			<label for="user_type_new">新用户</label>
			
			<p style="color:#FF8400;font-weight:bold">注:新用户为已入驻彩虹网短信</p>
		</dd>
	</dl>
	<dl>
		<dt></dt>
...
function setConfigAjax(){
	...
	$.ajax({
		type:"post",
		url:"<?php echo __URL('ADMIN_MAIN/config/setmobilemessage'); ?>",
		data:{
			'is_use':is_use,
			'app_key':app_key,
