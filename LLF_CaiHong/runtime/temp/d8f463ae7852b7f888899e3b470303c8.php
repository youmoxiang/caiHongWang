<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:50:"template/adminblue\Goods\virtualGoodsTypeList.html";i:1511596986;s:28:"template/adminblue\base.html";i:1512444889;s:45:"template/adminblue\controlCommonVariable.html";i:1515231611;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1515372762;s:34:"template/adminblue\openDialog.html";i:1509523953;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
function LoadingInfo(page_index) {
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/goods/virtualGoodsTypeList'); ?>",
		data : {
			...
			if (data["data"].length > 0) {
				for (var i = 0; i < data["data"].length; i++) {
					html += '<tr align="center">';
						...
						html += '<td>' + data["data"][i]["virtual_goods_type_name"] + '</td>';
						html += '<td>' + data["data"][i]["validity_period"] + '天</td>';
	...
	$( "#dialog" ).dialog({
		buttons: {
			"确定": function() {
				...
				$.ajax({
					type : "post",
					url : "<?php echo __URL('ADMIN_MAIN/goods/deleteVirtualGoodsType'); ?>",
...
function setVirtualGoodsTypeIsEnabled(virtual_goods_type_id,is_enabled){
	$.ajax({
		type : "post",
		async : false,
		url : "<?php echo __URL('ADMIN_MAIN/goods/setVirtualGoodsTypeIsEnabled'); ?>",
