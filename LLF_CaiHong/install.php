		...
		if(strstr(PHP_VERSION, '7.'))
		{
    		...
    		if(empty($error)) {
     		...
     		if(empty($error)) {
                ...
                //循环添加数据
                if(file_exists(IA_ROOT . '/LLF.sql')){
                    ...
                    $sql = file_get_contents(IA_ROOT . '/LLF.sql');
                    $sql = str_replace("\r", "\n", $sql);
                    $sql = explode(";\n", $sql);
...
<html lang="zh-cn">
	<head>
		...
		<title>安装系统 - LLF-彩虹网商城</title>
		<link rel="shortcut  icon" type="image/x-icon" href="/fangkun/LLF_CaiHong/template/shop/blue/public/images/favicon.ico" media="screen"/>
		...
		<div class="container">
			<div class="header" style="margin:15px auto;">
				<ul class="nav nav-pills pull-right" role="tablist">
					<li role="presentation" class="active"><a href="javascript:;">LLF-彩虹网商城</a></li>
					<li role="presentation"><a target = "_blank" href="http://www.qq.com">LLF-彩虹网商城官网</a></li>
					<li role="presentation"><a target = "_blank" href="http://www.qq.com">访问论坛</a></li>
				</ul>
				<img src="public/admin/images/install.png" />
			</div>
			...
			<div class="footer" style="margin:15px auto;">
				<div class="text-center">
					<a  target = "_blank" href="http://www.qq.com">LLF-彩虹网商城官网</a> &nbsp; &nbsp; <a  target = "_blank" href="http://www.qq.com">LLF-彩虹网商城论坛</a> &nbsp; &nbsp; <a target = "_blank" href="http://www.qq.com">购买授权</a>
				</div>
				<div class="text-center">
					Powered by <a   target = "_blank" href="http://127.0.0.1/fangkun/LLF_CaiHong/template/shop/blue/biaobai.html"><b>LLF-彩虹网商城</b></a> niu_version &copy; 2018-2028 <a target = "_blank" href="http://www.qq.com">www.qq.com</a>
				</div>
			</div>
		</div>
	...
	echo <<<EOF
		<div class="panel panel-default">
			...
			<div class="panel-body" style="overflow-y:scroll;max-height:400px;line-height:20px;">
				<h3>版权所有 (c)2018，LLF-彩虹网商城LLF保留所有权利。 </h3>
				<p>
					感谢您选择LLF-彩虹网商城。这个商城只是一个毕业设计，只可用于演示（由LLF-FK制作） <br />
					为了使你正确并合法的使用本软件，请你在使用前务必阅读清楚下面的协议条款：
				</p>
				<p>
					<strong>一、本授权协议适用且仅适用于LLF-彩虹网商城系统(以下简称LLF)任何版本，LLF-彩虹网商城官方对本授权协议的最终解释权。</strong>
				</p>
				<p>
					<strong>二、协议许可的权利 </strong>
					<ol>
						<li>非授权用户允许商用，严禁去除LLF-彩虹网商城相关的版权信息。</li>
                        <li>请尊重LLF-彩虹网商城开发人员劳动成果，严禁使用本系统转卖、销售或二次开发后转卖、销售等商业行为。</li>
                        <li>任何企业和个人不允许对程序代码以任何形式任何目的再发布。</li>
						<li>您可以在协议规定的约束和限制范围内修改LLF-彩虹网商城或界面风格以适应您的网站要求。</li>
				...
				<p>
					...
					<ol>
						<li>未获商业授权之前，允许您对LLF-彩虹网商城应用于商业用途，但严禁去除LLF-彩虹网商城任何相关的版权信息。</li>
						<li>未经官方许可，不得对本软件或与之关联的商业授权进行出租、出售、抵押或发放子许可证。</li>
						<li>未经官方许可，禁止在LLF-彩虹网商城的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</li>
				...
				<p>
					...
					<ol>
						...
						<li>电子文本形式的授权协议如同双方书面签署的协议一样，具有完全的和等同的法律效力。您一旦开始确认本协议并安装LLF-彩虹网商城，即被视为完全理解并接受本协议的各项条款，在享有上述条款授予的权力的同时，受到相关的约束和限制。协议许可范围以外的行为，将直接违反本授权协议并构成侵权，我们有权随时终止授权，责令停止损害，并保留追究相关责任的权力。</li>
...
function tpl_install_env($ret = array()) {
	...
	echo <<<EOF
		...
		<div class="alert alert-info">系统要求LLF-彩虹网商城安装目录下的runtime和upload必须可写, 才能使用LLF-彩虹网商城所有功能。</div>
		<div class="panel panel-default">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						...
						<!-- <div class="help-block">
							...
							在线安装能够直接安装最新版本LLF-彩虹网商城系统, 如果在线安装困难, 请下载离线安装包后使用本地安装. <br/>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input class="form-control" type="text" name="db[name]" id="dbname" value="LLF">
					</div>
				</div>
			</div>
		</div>
...
// 	$themes = get_store_theme();
	...
	<div class="alert alert-success">
		恭喜您!已成功安装“LLF-彩虹网商城”系统，您现在可以: <a target="_blank" class="btn btn-success" href="./index.php">访问网站首页</a>
