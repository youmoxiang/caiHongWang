<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:38:"template/shop\blue\Login\register.html";i:1509419440;s:42:"template/shop\blue\Login\registerBase.html";i:1515575350;s:32:"template/shop\blue\urlModel.html";i:1510819886;s:35:"template/shop\blue\loginTopNav.html";i:1508291124;}*/ ?>
<!DOCTYPE html>
...
<div class="reg-type">
	...
	<ul class="clearfix">
		...
		<?php endif; ?>
				...
				<div class="reg-wrap">
					<div class="reg-wrap-con" style="background: url(__TEMP__/<?php echo $style; ?>/public/images/register_bg_image.png) no-repeat right 70px;">
...
<div id="user_protocol" style="display: none;">
	<div class="protocol">
		<div class="protocol-con">
			...
			<p>本协议是您与<?php echo $platform_shopname; ?>（简称"本站"，网址：www.caihongwang.com）所有者之间就<?php echo $platform_shopname; ?>网站服务等相关事宜所订立的契约，请您仔细阅读本注册协议，您点击"同意并继续"按钮后，本协议即构成对双方有约束力的法律文件。</p>
