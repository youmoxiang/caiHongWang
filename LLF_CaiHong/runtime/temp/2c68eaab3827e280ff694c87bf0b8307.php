<?php if (!defined('THINK_PATH')) exit(); /*a:21:{s:35:"template/shop\blue\Index\index.html";i:1515584338;s:28:"template/shop\blue\base.html";i:1510626416;s:32:"template/shop\blue\urlModel.html";i:1510819886;s:43:"template/shop\blue\Index\controlHeadAd.html";i:1515319848;s:34:"template/shop\blue\controlTop.html";i:1515575916;s:41:"template/shop\blue\controlHeadSerach.html";i:1515575836;s:44:"template/shop\blue\controlHeadSearchAdv.html";i:1515575820;s:43:"template/shop\blue\controlHeadGoodType.html";i:1515575810;s:40:"template/shop\blue\controlCommonNav.html";i:1502706002;s:44:"template/shop\blue\Index\controlHeadNav.html";i:1515663814;s:49:"template/shop\blue\Index\controlHeadNavRight.html";i:1515319790;s:43:"template/shop\blue\controlRightSidebar.html";i:1510626416;s:45:"template/shop\blue\Index\controlIndexAdv.html";i:1510919116;s:56:"template/shop\blue\Index\controlLimitedTimeDiscount.html";i:1515574202;s:49:"template/shop\blue\Index\controlCommendBlock.html";i:1513931376;s:45:"template/shop\blue\Index\controlRecFloor.html";i:1513308244;s:51:"template/shop\blue\Index\controlFriendshipLink.html";i:1515319856;s:45:"template/shop\blue\controlBottomLinkHelp.html";i:1515575766;s:37:"template/shop\blue\controlBottom.html";i:1517364912;s:36:"template/shop\blue\controlLogin.html";i:1508897750;s:37:"template/shop\blue\baidu_js_push.html";i:1499844478;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<style type="text/css">
	*{
	...
	.btn{
		...
		display: none;
		border:0px;
		background-color: rgba(249,38,114,0);
	}
...
<div class="lunbo">
	...
	<div class="box">
		<img src="__TEMP__/<?php echo $style; ?>/public/images/image/lunbo1.jpg">
		<img src="__TEMP__/<?php echo $style; ?>/public/images/image/lunbo2.jpg">
		<img src="__TEMP__/<?php echo $style; ?>/public/images/image/lunbo3.jpg">
		<img src="__TEMP__/<?php echo $style; ?>/public/images/image/lunbo4.jpg">
		<img src="__TEMP__/<?php echo $style; ?>/public/images/image/lunbo5.jpg">
		<img src="__TEMP__/<?php echo $style; ?>/public/images/image/lunbo6.jpg">
		<img src="__TEMP__/<?php echo $style; ?>/public/images/image/lunbo1.jpg">			
	</div>
	<div class="btn">
...
/*		块一*/
	$('.fugai1')
	.css({"background-image":"url(__TEMP__/<?php echo $style; ?>/public/images/image/lunbo"+n+".jpg)",'background-repeat':'no-repeat','display':'block',"backgroundPosition-x":0+'px'})
	.animate({"backgroundPosition-x":-775+'px'},3000)
	.css({'display':'none'})
	//块二
	$('.fugai2')
	.css({"background-image":"url(__TEMP__/<?php echo $style; ?>/public/images/image/lunbo"+n+".jpg)",'background-repeat':'no-repeat','display':'block',"backgroundPosition-x":-200+'px'})
	.animate({"backgroundPosition-x":-775*2+'px'},3000)
	.animate({'display':'none'})
	//块三
	$('.fugai3')
	.css({"background-image":"url(__TEMP__/<?php echo $style; ?>/public/images/image/lunbo"+n+".jpg)",'background-repeat':'no-repeat','display':'block',"backgroundPosition-x":0+'px'})
	.animate({"backgroundPosition-x":-775*3+'px'},3000)
	.animate({'display':'none'})
/*		$('.fugai')
...
function xiaoguo(n){
	...
	$('.dian').animate({'width':775+'px'},2000)
	$('.dian').animate({'width':0+'px'},100)
	$('.box').animate({'margin-left':-n*775+'px'},2000,function(){
		if(n==6){
...
clearInterval(stop);
	stop=null;			
		huan(-1);	
		if(i==0){
			$('.btn-con-l').html('<img src="__TEMP__/<?php echo $style; ?>/public/images/image/lunbo'+parseInt(6)+'.jpg">')
		}else{
			$('.btn-con-l').html('<img src="__TEMP__/<?php echo $style; ?>/public/images/image/lunbo'+parseInt(i)+'.jpg">')
		}
		$('.box').stop(true,true);
		$('.dian').stop(true,true);
...
$('.btn-r').click(function(){
	...
	stop=null;
		huan(1);			
		if(i==5){
			$('.btn-con-r').html('<img src="__TEMP__/<?php echo $style; ?>/public/images/image/lunbo'+parseInt(1)+'.jpg">')
		}else if (i==6) {
			$('.btn-con-r').html('<img src="__TEMP__/<?php echo $style; ?>/public/images/image/lunbo'+parseInt(2)+'.jpg">')
		}else{
			$('.btn-con-r').html('<img src="__TEMP__/<?php echo $style; ?>/public/images/image/lunbo'+parseInt(i+2)+'.jpg">')
		}
		$('.box').stop(true,true);
		$('.dian').stop(true,true);
});
