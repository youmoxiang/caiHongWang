<?php if (!defined('THINK_PATH')) exit(); /*a:14:{s:38:"template/shop\blue\Member\balance.html";i:1510827806;s:28:"template/shop\blue\base.html";i:1510626416;s:32:"template/shop\blue\urlModel.html";i:1510819886;s:34:"template/shop\blue\controlTop.html";i:1515575916;s:41:"template/shop\blue\controlHeadSerach.html";i:1515575836;s:44:"template/shop\blue\controlHeadSearchAdv.html";i:1515575820;s:43:"template/shop\blue\controlHeadGoodType.html";i:1515575810;s:40:"template/shop\blue\controlCommonNav.html";i:1502706002;s:46:"template/shop\blue\Member\controlLeftMenu.html";i:1511781218;s:41:"template/shop\blue\controlCommonPage.html";i:1502679158;s:45:"template/shop\blue\controlBottomLinkHelp.html";i:1515575766;s:37:"template/shop\blue\controlBottom.html";i:1517364912;s:36:"template/shop\blue\controlLogin.html";i:1508897750;s:37:"template/shop\blue\baidu_js_push.html";i:1499844478;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
$(function(){
	...
	<div class="member-main" >
		<div class="box">
			<div class="tabmenu">
				<ul class="tab">
					<li class="active"><?php echo lang('member_account_balance'); ?></li>
				</ul>
			</div>
			<div class="member-data-header">
				<span class="member-data-title">
					...
					<?php echo $shopname; endif; ?>
					<span class="sum">(<?php echo lang('member_balance'); ?>:<?php echo $sum; ?>)</span>
				</span>
				<div class="common-btn" onclick="recharge();" style="float:right;"><?php echo lang('member_recharge_balance'); ?></div>
			</div>
			<?php if($total_count != ''): ?>
			<table>
				<tr align="center">
					<td><?php echo lang('member_category'); ?></td>
					<td><?php echo lang('member_amount_money'); ?></td>
					<td><?php echo lang('member_describe'); ?></td>
					<td><?php echo lang('member_time'); ?></td>
				</tr>
				<tbody id="list_content" class="close-order">
					<?php foreach($balances['data'] as $balance): ?>
					<tr align="center">
						<td><?php echo $balance['type_name']; ?></td>
						<td><?php echo $balance['number']; ?></td>
						<td><?php echo $balance['text']; ?></td>
						<td><?php echo getTimeStampTurnTime($balance['create_time'] ); ?></td>
					</tr>
					<?php endforeach; ?>
				</tbody>
			</table>
...
<div id="pagination" class="page" >
	...
	<div class="page-num fr">
		...
		<div id="page_list" style="float: left;<?php echo $path_info; ?>">
			...
			<!-- 总页数小于总页码时就都显示 -->
			<?php if($page_count <= $page_num): $__FOR_START_26676__=1;$__FOR_END_26676__=$page_count+1;for($i=$__FOR_START_26676__;$i < $__FOR_END_26676__;$i+=1){ if($i == $page): ?>
			...
			<?php elseif($page <= ($page_num-1)/2): $__FOR_START_32519__=1;$__FOR_END_32519__=$page_num+1;for($i=$__FOR_START_32519__;$i < $__FOR_END_32519__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info.'?page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 如果总页数等于当前页 或者 总页数小于当前页加上页码总数平均值显示 -->
			<?php elseif($page_count == $page or $page_count <= $page+($page_num-1)/2): $__FOR_START_12614__=$page_count-$page_num+1;$__FOR_END_12614__=$page_count+1;for($i=$__FOR_START_12614__;$i < $__FOR_END_12614__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info.'?page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 否则就正常显示 -->
			<?php else: $__FOR_START_22817__=$page-($page_num-1)/2;$__FOR_END_22817__=$page+($page_num-1)/2+1;for($i=$__FOR_START_22817__;$i < $__FOR_END_22817__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info.'?page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } endif; ?>
...
<?php endif; else: ?>
			<div>
				<div class="emptyFrame"> <i class="user_balance"></i><span><?php echo lang('member_no_balance_yet'); ?>！</span> </div>
			</div>
			<?php endif; ?>
		</div>
	</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel"><?php echo lang('recharge_balance'); ?></h4>
				</div>
				<div class="modal-body">
					<div class="modal-infp-style">
						<table>
							<tr>
								<td style="width:20%"><?php echo lang('member_amount_money'); ?>：</td>
								<td colspan='3'>
									<input type="text" placeholder="<?php echo lang('member_input_balance'); ?>" id="pay_money" style="height: 25px;" onkeyup="this.value=this.value.replace(/[^0-9.]/g,'')" />
								</td>
							</tr>
						</table>
						<input type="hidden" id="pay_no" value="<?php echo $pay_no; ?>" />
					</div>
				</div>
				<div class="modal-footer">
					<button class="btn btn-info" onclick="calculateRecharge()" id="butSubmit" data-dismiss="modal" aria-hidden="true" style="display:inline-block;"><?php echo lang('member_submit'); ?></button>
...
function calculateRecharge(){
	...
	if(pay_money < 0 || pay_money == '' || pay_money == 0){
		...
		$.msg("<?php echo lang('member_amount_greater_zero'); ?>");
		return false;
	}
	if(is_submint){
		return false;
	...
	is_submint = true;
	$.ajax({
		url: "<?php echo __URL('SHOP_MAIN/member/createrechargeorder'); ?>",
		type: "post",
		async: false,
		...
		success: function (response) {
			if(response.code>0){
				...
				is_submint = false;
				showBox("<?php echo lang('member_recharge_failed'); ?>");
			}
		}
	});
}
